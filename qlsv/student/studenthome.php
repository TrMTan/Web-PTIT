...
<body class="bg-3">
    ...
    <?php if (isset($_SESSION['message'])): ?>
        <div class="alert alert-<?php echo ($_SESSION['message_type'] == 'success') ? 'success' : 'danger'; ?> alert-dismissible fade show mt-4 ms-4 fs-6 position-absolute" style="top: 85px; right: 5px; max-width: 270px" role="alert">
